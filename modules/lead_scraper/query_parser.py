...
class QueryParser:
    ...
    Usage:
        parser = QueryParser()
        filters = parser.parse("PME dans la publicité à Paris")
        # {'codes_ape': ['73.11Z'], 'departements': ['75'], ...}
    """
    ...
    def __init__(
        ...
        Args:
            ...
            model: Modèle à utiliser (optionnel, utilise ANTHROPIC_MODEL par défaut)
